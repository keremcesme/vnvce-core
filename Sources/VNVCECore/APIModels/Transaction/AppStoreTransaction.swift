...
//public init(id: String, originalID: String, appAccountToken: UUID, productID: String, appBundleID: String, purchaseDate: Double, originalPurchaseDate: TimeInterval, purchasedQuantity: Int, productType: AppStoreProductType, ownershipType: AppStoreProductOwnershipType, webOrderLineItemID: String?, subscriptionGroupID: String?, expirationDate: TimeInterval?, isUpgraded: Bool?, offerType: AppStoreOfferType?, offerID: String?, revocationDate: TimeInterval?, revocationReason: AppStoreRevocationReason?, signedDate: TimeInterval) {
//    self.id = id
//    self.originalID = originalID
//    self.appAccountToken = appAccountToken
//    self.productID = productID
